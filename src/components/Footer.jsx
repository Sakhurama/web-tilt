...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Ig",
      url: "https://www.instagram.com/tilt_skateboards?igsh=MWV0OTQzMHAzd2pnZQ=="
    },
    {
      name: "Fb",
      url: "https://www.facebook.com/TiltSkateshop/"
    },
    {
      name: "Yt",
      url: "https://www.youtube.com/channel/UCHsrQgEUMoAINYqHTBGa6mQ"
    }
  ]
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded bg-gray-900 flex items-center justify-center text-gray-400 hover:text-white hover:bg-tiltRed transition-colors font-bold text-sm uppercase cursor-pointer">
                  {social.name}
                </a>
              ))}
            </div>
